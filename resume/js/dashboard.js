...
$.ajax({
    ...
    $.each(data.features, function(key, value){
      if (value.properties.Status === 'Progressing') {var status_button = "<span class=\"status btn btn-success\">Progressing</span>"}
      else if (value.properties.Status === 'Stalled') {var status_button = "<span class=\"status btn btn-warning\">Stalled</span>"}
      else if (value.properties.Status === 'Stopped') {var status_button = "<span class=\"status btn btn-danger\">Stopped</span>"}
      else {}
